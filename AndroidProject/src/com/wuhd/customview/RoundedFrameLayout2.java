...
public class RoundedFrameLayout2 extends FrameLayout {
	...
	public RoundedFrameLayout2(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}
	...
	private void init() {
		topLeftRadius = radiu;
		topRightRadius = radiu;
		bottomLeftRadius = radiu;
		bottomRightRadius = radiu;
...
//	@Override
//	protected void dispatchDraw(Canvas canvas) {
//		android.graphics.Bitmap bitmap = android.graphics.Bitmap.createBitmap(canvas.getWidth(),
//				canvas.getHeight(), android.graphics.Bitmap.Config.ARGB_8888);
